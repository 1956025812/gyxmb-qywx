...
public class MyBatisPlusGenerator {
    ...
    private static final String database = "gyxmb_qywx";
    private static final String url = "jdbc:mysql://120.24.59.39:3306/" + database + "?useUnicode=true&useSSL=false&characterEncoding=utf8";
    ...
    public static void main(String[] args) {
        ...
        generate("DuXueBo", "com.gyxmb.qywx", Arrays.asList(""), "t_");
    }
     ...
     * @param tableList   具体表名称集合
     * @param tablePrefix 表前缀
     */
    public static void generate(String author, String packageName, List<String> tableList, String... tablePrefix) {
        ...
        Map<String, String> names = new JdbcRepository().getEntityNames(tableList, tablePrefix);
    ...
    private static GlobalConfig initGlobalConfig(String author, String packageName) {
        ...
        String tmp = MyBatisPlusGenerator.class.getResource("").getPath();
    ...
    public static class JdbcRepository {
         ...
         * @return
         */
        public Map<String, String> getEntityNames(List<String> tables, String... tablePrefixArray) {
            //该sql语句目前支持mysql
